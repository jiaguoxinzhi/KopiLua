...
namespace Linyee.AT
{
    ...
    public static class ATTools
    {
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public static bool IsSystemNumericType(this object o)
        {
            return (o is byte ||
                o is sbyte ||
                o is short ||
        ...
        public static void printf(this string Format, params object[] Parameters)
        {
        ...
        /// <param name="Format"></param>
        /// <param name="Parameters"></param>
        public static void fprintf(this TextWriter Destination, string Format, params object[] Parameters)
        {
        ...
        /// <param name="Parameters"></param>
        /// <returns></returns>
        public static string sprintf(this string Format, params object[] Parameters)
        {
            #region Variables
